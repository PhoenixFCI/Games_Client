...
public class GameOver implements Screen
{
    ...
    public void show()
    {
        ...
        button1.setPosition((Gdx.graphics.getWidth()-button1.getWidth())/2,200);


        button2 = new TextButton("Menu",myskin);
        button2.setSize(col_width*4,row_height);
        button2.setPosition((Gdx.graphics.getWidth()-button2.getWidth())/2,10);
        ...
        buttonH.setPosition((Gdx.graphics.getWidth()-buttonH.getWidth())/2,400);
